    ...
    return (
        <div className="p-2 w-full h-full flex flex-col justify-between z-50 relative">
            ...
            <div className="flex button justify-end w-full ">
                <div className="bg-light rounded-full px-6 py-1 md:py-2 w-full text-center sub-body md:body m-auto">
                    {type}
                </div>
                <div className="py-1 md:py-2 px-3 bg-light rounded-full  flex items-center justify-center text-[14px] md:text-[20px] ">
                    {icon}
                </div>
            </div>
        </div>
