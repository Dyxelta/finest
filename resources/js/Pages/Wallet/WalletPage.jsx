            ...
            <div className="flex h-[280px] gap-8">
                <div className="h-full w-full bg-primary rounded-md flex-1 rounded-e-3xl  flex ">
                    <div className="w-2/3 pl-6 md:pl-12 py-2 flex flex-col justify-center  text-light">
                        ...
                        <div className="sub-body-14 pr-4">With our innovative platform, managing your finances has never been easier. View your wallet, where you can track your spending, set budgets, and monitor your savings all at once!.</div>
                    </div>
                    <div className="w-1/3 h-full bg-white border-dashed border-2 border-dark rounded-3xl "></div>
                </div>
